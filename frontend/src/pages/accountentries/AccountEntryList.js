  ...
  return (
    <div className="p-4 md:p-6 max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h1 className="text-2xl font-semibold text-gray-800">Account Entries</h1>
          <p className="text-sm text-gray-500">General notes-with-numbers and Contra (cash/bank/upi internal movements).</p>
        </div>
        {canCreate && (
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50 text-xs uppercase text-gray-500">
                <tr>
                  ...
                  <th className="text-left py-3 px-4">Contra</th>
