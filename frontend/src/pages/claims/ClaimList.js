...
const ClaimList = () => {
  ...
  const StatusBadge = ({ c, loading }) => {
    ...
    const openDrop = (e) => {
      ...
      // Dropdown grows to fit long labels (e.g. "Pre-Auth Claim Under
      // Process") up to ~360px; clamp left so the right edge stays in view.
      ...
      <div onClick={e => e.stopPropagation()}>
        ...
        {isOpen && ReactDOM.createPortal(
          <>
            ...
            <div style={{ top: pos.top, left: pos.left, minWidth: 224, maxWidth: pos.maxWidth }} className="fixed z-50 bg-white rounded-2xl shadow-2xl shadow-black/10 border border-gray-100 overflow-hidden">
