...
const ReferencesReport = () => {
  ...
  return (
    <div className="p-4 md:p-6 max-w-7xl mx-auto">
      ...
      <h1 className="text-2xl font-semibold text-gray-800">References Report</h1>
      <p className="text-sm text-gray-500 mb-5">Business given vs commission paid, per reference.</p>
