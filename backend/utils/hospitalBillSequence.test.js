...
eq('blank -> seed 0, width 4 (default, matches INV-YYYY-XXXX)', parseBillStart(''), { seed: 0, width: 4 });
eq('null -> seed 0, width 4', parseBillStart(null), { seed: 0, width: 4 });
...
eq('non-digits -> seed 0, width 4 (default)', parseBillStart('abc'), { seed: 0, width: 4 });
